      ...
      <div className="mx-auto grid max-w-7xl grid-cols-2 gap-px px-4 sm:px-6 lg:grid-cols-4 lg:px-8">
        {items.map((s) => (
          <div key={s.label} className="px-2 py-10 text-center lg:py-12">
            <p className="font-bold text-4xl font-semibold text-prime-gold lg:text-5xl">
              {s.value}
            </p>
    ...
    <section className="border-y border-white/10 bg-prime-black">
      <div className="mx-auto grid max-w-7xl grid-cols-2 gap-px px-4 sm:px-6 lg:grid-cols-4 lg:px-8">
        {STATS_FALLBACK.map((s) => (
          <div key={s.label} className="px-2 py-10 text-center lg:py-12">
            <p className="font-bold text-4xl font-semibold text-prime-gold lg:text-5xl animate-pulse">
              {s.value}
            </p>
            <p className="mt-2 text-xs uppercase tracking-widest text-white/50">
              {s.label}
    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-16 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            <div className="lg:sticky lg:top-28">
              ...
              <h2 className="mt-4 font-bold text-4xl font-medium leading-tight text-white sm:text-5xl">
            ...
            <div className="divide-y divide-white/10">
              {VALUE_PROPS.map((vp) => (
                ...
                >
                  <span className="font-bold text-2xl font-medium text-white/25 transition-colors group-hover:text-prime-gold">
                    {vp.no}
                  </span>
      ...
      <section className="relative overflow-hidden bg-prime-black py-28">
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <h2 className="mt-5 font-bold text-4xl font-medium leading-tight text-white sm:text-5xl">
